...
let messageResult = `My favorite number: ${favoriteResult}`;
...
console.log(Result);
//Exercise 11
let names = ["Abdullah,Areeba,Salik,mahnnor,shehwar"];
...
//Exercise 14
let guestlist = ["fardeen", "Daniyal", "shariq"];
guestlist.forEach(guest => {
    console.log(`Dear ${guest}, you are cordially invited to dinner`);
});
//Exercise 15
let guestlists = ["Abdullah", "Areeba", "Ali"];
...
console.log("updated list of guest:", guestlist);
//Exercise 18
let placeToVisit = ["Paris", "New York", "Switzerland", "Turkey", "China"];
...
//Exercise 29
let favoriteFruits = ['apple', 'mango', 'cherry', 'banana'];
...
//Exercise 32
let current_users = ["saba", "zahara", "hassan", "naimal"];
let new_users = ["fahad", "kashif", "sara", "mantasha"];
...
//Exercise 45
function storeCarInfo(manufacturer, model, ...option) {
